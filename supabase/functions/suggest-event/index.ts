...
// функция пересылает его тебе в Telegram обычным сообщением. Ничего не пишет
// в базу — это просто уведомление, дальше ты сама решаешь, добавлять ли событие
// (можно переслать текст telegram-боту, который разберёт его в структуру).
//
// Секреты (уже заданы для функции telegram-bot, отдельно ставить не нужно):
